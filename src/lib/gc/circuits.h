...
void ANDTreeCircuit(GarbledCircuit* gc,
                    BuildContext* context,
                    uv64& in,
                    ui64& out);

void ORCircuit(GarbledCircuit* gc,
               BuildContext* context,
               ui64 n,
               ui64* inputs,
               ui64* outputs);

void XORCircuit(GarbledCircuit* gc,
                BuildContext* context,
                ui64 n,
                ui64* inputs,
                ui64* outputs);
...
void ANDCircuit(GarbledCircuit* gc,
                BuildContext* context,
                const uv64& in_a,
                const uv64& in_b,
                uv64& out);
...
void MIXEDCircuit(GarbledCircuit* gc,
                  BuildContext* context,
                  ui64 n,
                  ui64* inputs,
                  ui64* outputs);
...
void ADD32Circuit(GarbledCircuit* gc,
                  BuildContext* context,
                  ui64 a,
                  ui64 b,
                  ui64 cin,
...
void ADD22Circuit(GarbledCircuit* gc,
                  BuildContext* context,
                  ui64 a,
                  ui64 b,
                  ui64& s,
...
void SUB32Circuit(GarbledCircuit* gc,
                  BuildContext* context,
                  ui64 a,
                  ui64 b,
                  ui64 cin,
...
void INCCircuit(GarbledCircuit* gc,
                BuildContext* context,
                uv64& in,
                uv64& out,
                ui64& carry);

void ADDCircuit(GarbledCircuit* gc,
                BuildContext* context,
                const uv64& in_a,
                const uv64& in_b,
                uv64& out,
...
void SUBSlowCircuit(GarbledCircuit* gc,
                    BuildContext* context,
                    uv64& in_a,
                    uv64& in_b,
                    uv64& out,
...
void SUBCircuit(GarbledCircuit* gc,
                BuildContext* context,
                const uv64& in_a,
                const uv64& in_b,
                uv64& out,
...
void MULCircuit(GarbledCircuit* gc,
                BuildContext* context,
                const uv64& in_a,
                const uv64& in_b,
                uv64& out);
