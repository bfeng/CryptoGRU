...
void genericGate(GarbledCircuit* gc,
...
inline void NOTGate(GarbledCircuit* gc,
                    BuildContext* context,
                    ui64 in,
                    ui64& out) {
...
inline void ANDGate(GarbledCircuit* gc,
                    BuildContext* context,
                    ui64 in0,
                    ui64 in1,
                    ui64& out) {
...
inline void ORGate(GarbledCircuit* gc,
                   BuildContext* context,
                   ui64 in0,
                   ui64 in1,
                   ui64& out) {
...
inline void XORGate(GarbledCircuit* gc,
                    BuildContext* context,
                    ui64 in0,
                    ui64 in1,
                    ui64& out) {
...
inline void XNORGate(GarbledCircuit* gc,
                     BuildContext* context,
                     ui64 in0,
                     ui64 in1,
                     ui64& out) {
